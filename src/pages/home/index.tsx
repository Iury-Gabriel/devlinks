...
import { orderBy, collection, getDocs, query, doc, getDoc } from "firebase/firestore";
...
export function Home() {
    ...
    return (
        <div className="flex flex-col w-full py-4 items-center justify-center">
            <h1 className="md:text-4xl text-3xl font-bold text-white mt-20">Iury Gabriel</h1>
